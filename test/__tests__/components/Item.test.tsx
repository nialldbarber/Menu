...
describe('components -> <Item />', () => {
  ...
  it('should render "Remove from cart" when button is pressed', async () => {
    ...
    await waitFor(() => expect(getByText(/Remove from cart/i)).toBeTruthy())
  })
})
